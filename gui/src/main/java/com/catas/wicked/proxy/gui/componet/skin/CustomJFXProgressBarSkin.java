package com.catas.wicked.proxy.gui.componet.skin;
...
public class CustomJFXProgressBarSkin extends ProgressIndicatorSkin {
    ...
    public CustomJFXProgressBarSkin(JFXProgressBar bar) {
        super(bar);
